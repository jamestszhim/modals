...
def _interpolate(img, class_info, magnitude):
    ...
    # print(type(class_info['mean']))
    # print(class_info['pool'][idxs]-class_info['mean'])
    distances = cosine(class_info['pool'][idxs]-class_info['mean'], x.detach().cpu()-class_info['mean']) #but not too far from the seed
